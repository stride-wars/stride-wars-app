...
func (bq *BaseQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (bq *BaseQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(base.Table, base.Columns, sqlgraph.NewFieldSpec(base.FieldID, field.TypeInt))
	_spec.From = bq.sql
