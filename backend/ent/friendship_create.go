...
func (fc *FriendshipCreate) SetID(i int) *FriendshipCreate {
	fc.mutation.SetID(i)
	return fc
}

// SetUsersID sets the "users" edge to the User entity by ID.
func (fc *FriendshipCreate) SetUsersID(id uuid.UUID) *FriendshipCreate {
	fc.mutation.SetUsersID(id)
	return fc
}

// SetUsers sets the "users" edge to the User entity.
func (fc *FriendshipCreate) SetUsers(u *User) *FriendshipCreate {
	return fc.SetUsersID(u.ID)
}

// SetFriendsID sets the "friends" edge to the User entity by ID.
func (fc *FriendshipCreate) SetFriendsID(id uuid.UUID) *FriendshipCreate {
	fc.mutation.SetFriendsID(id)
	return fc
}

// SetFriends sets the "friends" edge to the User entity.
func (fc *FriendshipCreate) SetFriends(u *User) *FriendshipCreate {
	return fc.SetFriendsID(u.ID)
}
...
func (fc *FriendshipCreate) check() error {
	...
	if len(fc.mutation.UsersIDs()) == 0 {
		return &ValidationError{Name: "users", err: errors.New(`ent: missing required edge "Friendship.users"`)}
	}
	if len(fc.mutation.FriendsIDs()) == 0 {
		return &ValidationError{Name: "friends", err: errors.New(`ent: missing required edge "Friendship.friends"`)}
	}
	return nil
}
...
func (fc *FriendshipCreate) createSpec() (*Friendship, *sqlgraph.CreateSpec) {
	...
	if nodes := fc.mutation.FriendsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: false,
