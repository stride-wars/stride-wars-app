...
func (e FriendshipEdges) UsersOrErr() (*User, error) {
	if e.Users != nil {
		return e.Users, nil
...
// was not loaded in eager-loading, or loaded but was not found.
func (e FriendshipEdges) FriendsOrErr() (*User, error) {
	if e.Friends != nil {
...
// QueryUsers queries the "users" edge of the Friendship entity.
func (f *Friendship) QueryUsers() *UserQuery {
	return NewFriendshipClient(f.config).QueryUsers(f)
}

// QueryFriends queries the "friends" edge of the Friendship entity.
func (f *Friendship) QueryFriends() *UserQuery {
	return NewFriendshipClient(f.config).QueryFriends(f)
}
